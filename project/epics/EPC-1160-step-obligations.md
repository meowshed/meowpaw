...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Every requirement maps to a labelled rule that exists where the task names it       | A script read the six step tasks' traces and found every label in its step file: 139 traced labels found, 0 missing, and TSK-1580 maps the other fifteen to template lines. **Corrected by BUG-1170**: #238 recorded a run whose pattern matched nothing |
