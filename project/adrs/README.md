...
| [ADR-1170](ADR-1170-an-approval-is-a-stored-status-a-check-holds-frozen.md)                          | An approval is a stored status that a check holds frozen, and a session opens with what waits for one | draft                         |
