...
21 decisions in all: 20 approved, 1 draft.
...
| [ADR-1200](ADR-1200-the-harness-holds-its-quality-attributes-with-evidence.md)                       | The harness holds its quality attributes, each with a check or a stated piece of evidence              | draft    |
