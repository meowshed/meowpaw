...
23 decisions in all: 22 approved, 1 draft.
...
| [ADR-1220](ADR-1220-an-insight-is-a-kind-of-record.md)                                               | An insight is a kind of record, written only when something was learned                                | draft    |
