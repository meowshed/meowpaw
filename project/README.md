...
None in force, as [adrs/README.md](adrs/README.md) records. ADR-1000 is
drafted and waiting on approval, and it is the first turn the design step has
run against the requirements as they now stand.
...
in five tasks, TSK-1010 to TSK-1050. TSK-1000 is the planning task that
produced all of it. `tools/check_coverage.py` reports every requirement the
decision addresses landing in exactly one task.
